...
import { C as require_isFunction, S as require_memoize, _ as require_isNaN, a as require_isPlainObject, b as require_isNil, c as require_mapValues, d as require_min, f as require_max, g as require_upperFirst, h as require_uniqBy, i as require_isBoolean, l as require_isEqual, m as require_sortBy, n as require_range, o as require_last, p as require_throttle, r as require_find, s as require_every, t as require_some, u as require_flatMap, v as require_isNumber, w as require_isObject, x as require_get, y as require_isString } from "./lodash.mjs";
...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$34(_objectSpread$34({}, _objectWithoutProperties$16(_ref, _excluded$16)), {}, {
		type,
		size,
		sizeType
	});
...
var DecimalCSS = /*#__PURE__*/ function() {
	...
	return _createClass$15(DecimalCSS, [
		...
		value: function parse(str) {
			...
			var _ref2 = _slicedToArray$5((_NUM_SPLIT_REGEX$exec = NUM_SPLIT_REGEX.exec(str)) !== null && _NUM_SPLIT_REGEX$exec !== void 0 ? _NUM_SPLIT_REGEX$exec : [], 3), numStr = _ref2[1], unit = _ref2[2];
...
function calculateArithmetic(expr) {
	...
	while (newExpr.includes("*") || newExpr.includes("/")) {
		...
		var _ref4 = _slicedToArray$5((_MULTIPLY_OR_DIVIDE_R = MULTIPLY_OR_DIVIDE_REGEX.exec(newExpr)) !== null && _MULTIPLY_OR_DIVIDE_R !== void 0 ? _MULTIPLY_OR_DIVIDE_R : [], 4), leftOperand = _ref4[1], operator = _ref4[2], rightOperand = _ref4[3];
	...
	while (newExpr.includes("+") || /.-\d+(?:\.\d+)?/.test(newExpr)) {
		...
		var _ref6 = _slicedToArray$5((_ADD_OR_SUBTRACT_REGE = ADD_OR_SUBTRACT_REGEX.exec(newExpr)) !== null && _ADD_OR_SUBTRACT_REGE !== void 0 ? _ADD_OR_SUBTRACT_REGE : [], 4), _leftOperand = _ref6[1], _operator = _ref6[2], _rightOperand = _ref6[3];
...
function calculateParentheses(expr) {
	...
	while (newExpr.includes("(")) {
		var parentheticalExpression = _slicedToArray$5(PARENTHESES_REGEX.exec(newExpr), 2)[1];
...
var calculateWordsByLines = function calculateWordsByLines(_ref2, initialWordsWithComputedWith, spaceWidth, lineWidth, scaleToFit) {
	...
	while (start <= end && iterations <= text.length - 1) {
		...
		var _checkOverflow2 = _slicedToArray$4(checkOverflow(middle - 1), 2), doesPrevOverflow = _checkOverflow2[0], result = _checkOverflow2[1];
		var doesMiddleOverflow = _slicedToArray$4(checkOverflow(middle), 1)[0];
...
function typeguardBarRectangleProps(_ref, props) {
	...
	return _objectSpread$17(_objectSpread$17(_objectSpread$17(_objectSpread$17(_objectSpread$17({}, props), option), x ? { x } : {}), y ? { y } : {}), {}, {
		height,
		width,
		name: props.name,
		radius: props.radius
...
function BarRectangle(props) {
	return /*#__PURE__*/ import_react.createElement(Shape, _extends$17({
		shapeType: "rectangle",
...
var Bar = /*#__PURE__*/ function(_PureComponent) {
	function Bar() {
		var _this;
		_classCallCheck$14(this, Bar);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$12(this, Bar, [].concat(args));
		_defineProperty$20(_this, "state", { isAnimationFinished: false });
		_defineProperty$20(_this, "id", uniqueId("recharts-bar-"));
	...
	_inherits$12(Bar, _PureComponent);
	return _createClass$14(Bar, [
		{
			...
			value: function renderRectanglesStatically(data) {
				...
				return data && data.map(function(entry, i) {
					...
					var props = _objectSpread$16(_objectSpread$16(_objectSpread$16({}, baseProps), entry), {}, {
						isActive,
						option,
						index: i,
						dataKey,
			...
			value: function renderRectanglesWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = data.map(function(entry, index) {
						...
						return _objectSpread$16(_objectSpread$16({}, entry), {}, { width: w });
					});
		...
		},
		{
			...
			value: function renderBackground() {
				...
				return data.map(function(entry, i) {
					...
					var props = _objectSpread$16(_objectSpread$16(_objectSpread$16(_objectSpread$16(_objectSpread$16({}, rest), {}, { fill: "#eee" }, background), backgroundProps), adaptEventsOfChild(_this4.props, entry, i)), {}, {
					...
					return /*#__PURE__*/ import_react.createElement(BarRectangle, _extends$16({
...
_Bar = Bar;
_defineProperty$20(Bar, "displayName", "Bar");
_defineProperty$20(Bar, "defaultProps", {
	xAxisId: 0,
	yAxisId: 0,
	legendType: "rect",
	minPointSize: 0,
...
*/
_defineProperty$20(Bar, "getComposedData", function(_ref2) {
	var props = _ref2.props, item = _ref2.item, barPosition = _ref2.barPosition, bandSize = _ref2.bandSize, xAxis = _ref2.xAxis, yAxis = _ref2.yAxis, xAxisTicks = _ref2.xAxisTicks, yAxisTicks = _ref2.yAxisTicks, stackedData = _ref2.stackedData, dataStartIndex = _ref2.dataStartIndex, displayedData = _ref2.displayedData, offset = _ref2.offset;
	var pos = findPositionOfBar(barPosition, item);
	if (!pos) return null;
	var layout = props.layout;
	var itemDefaultProps = item.type.defaultProps;
	var itemProps = itemDefaultProps !== void 0 ? _objectSpread$16(_objectSpread$16({}, itemDefaultProps), item.props) : item.props;
	...
	return _objectSpread$16({
		data: displayedData.map(function(entry, index) {
			...
			return _objectSpread$16(_objectSpread$16(_objectSpread$16({}, entry), {}, {
				x,
				y,
				width,
				height,
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		var ticks = getTicksOfScale(scale, _objectSpread$15(_objectSpread$15({}, axis), {}, { realScaleType }));
		if (axisType === "xAxis") {
		...
		var finalAxis = _objectSpread$15(_objectSpread$15(_objectSpread$15({}, axis), ticks), {}, {
			realScaleType,
			x,
			y,
			scale,
		...
		return _objectSpread$15(_objectSpread$15({}, result), {}, _defineProperty$19({}, id, finalAxis));
	}, {});
};
...
var ScaleHelper = /*#__PURE__*/ function() {
	function ScaleHelper(scale) {
		_classCallCheck$13(this, ScaleHelper);
		this.scale = scale;
	}
	return _createClass$13(ScaleHelper, [
		{
			key: "domain",
			get: function get() {
...
_defineProperty$19(ScaleHelper, "EPS", 1e-4);
var createLabeledScales = function createLabeledScales(options) {
	var scales = Object.keys(options).reduce(function(res, key) {
		return _objectSpread$15(_objectSpread$15({}, res), {}, _defineProperty$19({}, key, ScaleHelper.create(options[key])));
	}, {});
	return _objectSpread$15(_objectSpread$15({}, scales), {}, {
...
function getTicksEnd(sign, boundaries, getTickSize, ticks, minTickGap) {
	...
	var _loop = function _loop(i) {
		...
		if (i === len - 1) {
			...
			result[i] = entry = _objectSpread$14(_objectSpread$14({}, entry), {}, { tickCoord: gap > 0 ? entry.coordinate - gap * sign : entry.coordinate });
		} else result[i] = entry = _objectSpread$14(_objectSpread$14({}, entry), {}, { tickCoord: entry.coordinate });
		if (isVisible(sign, entry.tickCoord, getSize, start, end)) {
			end = entry.tickCoord - sign * (getSize() / 2 + minTickGap);
			result[i] = _objectSpread$14(_objectSpread$14({}, entry), {}, { isShow: true });
		}
	};
...
function getTicksStart(sign, boundaries, getTickSize, ticks, minTickGap, preserveEnd) {
	...
	if (preserveEnd) {
		...
		result[len - 1] = tail = _objectSpread$14(_objectSpread$14({}, tail), {}, { tickCoord: tailGap > 0 ? tail.coordinate - tailGap * sign : tail.coordinate });
		if (isVisible(sign, tail.tickCoord, function() {
			return tailSize;
		}, start, end)) {
			end = tail.tickCoord - sign * (tailSize / 2 + minTickGap);
			result[len - 1] = _objectSpread$14(_objectSpread$14({}, tail), {}, { isShow: true });
		}
	}
...
var CartesianAxis = /*#__PURE__*/ function(_Component) {
	function CartesianAxis(props) {
		var _this;
		_classCallCheck$12(this, CartesianAxis);
		_this = _callSuper$11(this, CartesianAxis, [props]);
		_this.state = {
			fontSize: "",
			letterSpacing: ""
		};
	...
	_inherits$11(CartesianAxis, _Component);
	return _createClass$12(CartesianAxis, [
		{
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$13(_objectSpread$13(_objectSpread$13({}, filterProps(this.props, false)), filterProps(axisLine, false)), {}, { fill: "none" });
				if (orientation === "top" || orientation === "bottom") {
					var needHeight = +(orientation === "top" && !mirror || orientation === "bottom" && mirror);
					props = _objectSpread$13(_objectSpread$13({}, props), {}, {
						x1: x,
				...
				return /*#__PURE__*/ import_react.createElement("line", _extends$15({}, props, { className: clsx("recharts-cartesian-axis-line", (0, import_get.default)(axisLine, "className")) }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks(ticks, fontSize, letterSpacing) {
				...
				var finalTicks = getTicks(_objectSpread$13(_objectSpread$13({}, this.props), {}, { ticks }), fontSize, letterSpacing);
				var textAnchor = this.getTickTextAnchor();
				var verticalAnchor = this.getTickVerticalAnchor();
				var axisProps = filterProps(this.props, false);
				var customTickProps = filterProps(tick, false);
				var tickLineProps = _objectSpread$13(_objectSpread$13({}, axisProps), {}, { fill: "none" }, filterProps(tickLine, false));
				var items = finalTicks.map(function(entry, i) {
					var _this2$getTickLineCoo = _this2.getTickLineCoord(entry), lineCoord = _this2$getTickLineCoo.line, tickCoord = _this2$getTickLineCoo.tick;
					var tickProps = _objectSpread$13(_objectSpread$13(_objectSpread$13(_objectSpread$13({
						textAnchor,
						verticalAnchor
					}, axisProps), {}, {
						stroke: "none",
					...
					}, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$15({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", (0, import_get.default)(tickLine, "className")) })), tick && CartesianAxis.renderTickItem(tick, tickProps, "".concat((0, import_isFunction.default)(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || "")));
				});
		...
		value: function renderTickItem(option, props, value) {
			...
			if (/*#__PURE__*/ import_react.isValidElement(option)) tickItem = /*#__PURE__*/ import_react.cloneElement(option, _objectSpread$13(_objectSpread$13({}, props), {}, { className: combinedClassName }));
			else if ((0, import_isFunction.default)(option)) tickItem = option(_objectSpread$13(_objectSpread$13({}, props), {}, { className: combinedClassName }));
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$15({}, props, { className: "recharts-cartesian-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.Component);
_defineProperty$17(CartesianAxis, "displayName", "CartesianAxis");
_defineProperty$17(CartesianAxis, "defaultProps", {
	x: 0,
	y: 0,
	width: 0,
	height: 0,
...
function renderLineItem(option, props) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) lineItem = /*#__PURE__*/ import_react.cloneElement(option, props);
		...
		lineItem = /*#__PURE__*/ import_react.createElement("line", _extends$14({}, restOfFilteredProps, {
			x1,
			y1,
			x2,
			y2,
...
function HorizontalGridLines(props) {
	...
	var items = horizontalPoints.map(function(entry, i) {
		return renderLineItem(horizontal, _objectSpread$12(_objectSpread$12({}, props), {}, {
			x1: x,
			y1: entry,
			x2: x + width,
			y2: entry,
...
function VerticalGridLines(props) {
	...
	var items = verticalPoints.map(function(entry, i) {
		return renderLineItem(vertical, _objectSpread$12(_objectSpread$12({}, props), {}, {
			x1: entry,
			y1: y,
			x2: entry,
			y2: y + height,
...
var defaultVerticalCoordinatesGenerator = function defaultVerticalCoordinatesGenerator(_ref, syncWithTicks) {
	...
	return getCoordinatesOfGrid(getTicks(_objectSpread$12(_objectSpread$12(_objectSpread$12({}, CartesianAxis.defaultProps), xAxis), {}, {
...
var defaultHorizontalCoordinatesGenerator = function defaultHorizontalCoordinatesGenerator(_ref2, syncWithTicks) {
	...
	return getCoordinatesOfGrid(getTicks(_objectSpread$12(_objectSpread$12(_objectSpread$12({}, CartesianAxis.defaultProps), yAxis), {}, {
...
function CartesianGrid(props) {
	...
	var propsIncludingDefaults = _objectSpread$12(_objectSpread$12({}, props), {}, {
	...
	if ((!horizontalPoints || !horizontalPoints.length) && (0, import_isFunction.default)(horizontalCoordinatesGenerator)) {
		...
		var generatorResult = horizontalCoordinatesGenerator({
			yAxis: yAxis ? _objectSpread$12(_objectSpread$12({}, yAxis), {}, { ticks: isHorizontalValues ? horizontalValues : yAxis.ticks }) : void 0,
			width: chartWidth,
			height: chartHeight,
			offset
		}, isHorizontalValues ? true : syncWithTicks);
		warn(Array.isArray(generatorResult), "horizontalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$16(generatorResult), "]"));
	...
	if ((!verticalPoints || !verticalPoints.length) && (0, import_isFunction.default)(verticalCoordinatesGenerator)) {
		...
		var _generatorResult = verticalCoordinatesGenerator({
			xAxis: xAxis ? _objectSpread$12(_objectSpread$12({}, xAxis), {}, { ticks: isVerticalValues ? verticalValues : xAxis.ticks }) : void 0,
			width: chartWidth,
			height: chartHeight,
			offset
		}, isVerticalValues ? true : syncWithTicks);
		warn(Array.isArray(_generatorResult), "verticalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$16(_generatorResult), "]"));
	...
	}), /*#__PURE__*/ import_react.createElement(HorizontalGridLines, _extends$14({}, propsIncludingDefaults, {
		offset,
		horizontalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(VerticalGridLines, _extends$14({}, propsIncludingDefaults, {
		offset,
		verticalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(HorizontalStripes, _extends$14({}, propsIncludingDefaults, { horizontalPoints })), /*#__PURE__*/ import_react.createElement(VerticalStripes, _extends$14({}, propsIncludingDefaults, { verticalPoints })));
}
...
var getPath$1 = function getPath(_ref) {
	...
	if (Array.isArray(baseLine)) {
		...
		var areaPoints = formatPoints.map(function(entry, index) {
			return _objectSpread$11(_objectSpread$11({}, entry), {}, { base: formatBaseLine[index] });
		});
...
var Curve = function Curve(props) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$13({}, filterProps(props, false), adaptEventHandlers(props), {
...
var Line = /*#__PURE__*/ function(_PureComponent) {
	function Line() {
		var _this;
		_classCallCheck$11(this, Line);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$10(this, Line, [].concat(args));
		_defineProperty$14(_this, "state", {
			isAnimationFinished: true,
			totalLength: 0
		});
		_defineProperty$14(_this, "generateSimpleStrokeDasharray", function(totalLength, length) {
			return "".concat(length, "px ").concat(totalLength - length, "px");
		});
		_defineProperty$14(_this, "getStrokeDasharray", function(length, totalLength, lines) {
		...
		_defineProperty$14(_this, "id", uniqueId("recharts-line-"));
		_defineProperty$14(_this, "pathRef", function(node) {
	...
	_inherits$10(Line, _PureComponent);
	return _createClass$11(Line, [
		{
			key: "componentDidMount",
			value: function componentDidMount() {
...
_defineProperty$14(Line, "displayName", "Line");
_defineProperty$14(Line, "defaultProps", {
	xAxisId: 0,
	yAxisId: 0,
	connectNulls: false,
	activeDot: true,
...
* @return {Array}  Composed data
*/
_defineProperty$14(Line, "getComposedData", function(_ref4) {
...
var Area = /*#__PURE__*/ function(_PureComponent) {
	function Area() {
		var _this;
		_classCallCheck$10(this, Area);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$9(this, Area, [].concat(args));
		_defineProperty$13(_this, "state", { isAnimationFinished: true });
		_defineProperty$13(_this, "id", uniqueId("recharts-area-"));
	...
	_inherits$9(Area, _PureComponent);
	return _createClass$10(Area, [
		{
			key: "renderDots",
			value: function renderDots(needClip, clipDot, clipPathId) {
				...
				var dotsProps = { clipPath: needClip ? "url(#clipPath-".concat(clipDot ? "" : "dots-").concat(clipPathId, ")") : null };
				return /*#__PURE__*/ import_react.createElement(Layer, _extends$10({ className: "recharts-area-dots" }, dotsProps), dots);
			}
		},
		{
		...
		},
		{
			...
			value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
				...
				_this$props4.ref;
				var others = _objectWithoutProperties$3(_this$props4, _excluded$3);
				return /*#__PURE__*/ import_react.createElement(Layer, { clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null }, /*#__PURE__*/ import_react.createElement(Curve, _extends$10({}, filterProps(others, true), {
					points,
					connectNulls,
					type,
					baseLine,
				...
				})), stroke !== "none" && /*#__PURE__*/ import_react.createElement(Curve, _extends$10({}, filterProps(this.props, false), {
					...
					fill: "none",
					points
				})), stroke !== "none" && isRange && /*#__PURE__*/ import_react.createElement(Curve, _extends$10({}, filterProps(this.props, false), {
					className: "recharts-area-curve",
					layout,
					type,
					connectNulls,
...
_Area = Area;
_defineProperty$13(Area, "displayName", "Area");
_defineProperty$13(Area, "defaultProps", {
	stroke: "#3182bd",
	fill: "#3182bd",
	fillOpacity: .6,
	xAxisId: 0,
...
_defineProperty$13(Area, "getBaseValue", function(props, item, xAxis, yAxis) {
...
_defineProperty$13(Area, "getComposedData", function(_ref4) {
...
_defineProperty$13(Area, "renderDotItem", function(option, props) {
	var dotItem;
	if (/*#__PURE__*/ import_react.isValidElement(option)) dotItem = /*#__PURE__*/ import_react.cloneElement(option, props);
	else if ((0, import_isFunction.default)(option)) dotItem = option(props);
	else {
		var className = clsx("recharts-area-dot", typeof option !== "boolean" ? option.className : "");
		var key = props.key, rest = _objectWithoutProperties$3(props, _excluded2$1);
		dotItem = /*#__PURE__*/ import_react.createElement(Dot, _extends$10({}, rest, {
			key,
			className
		}));
	}
...
var YAxisImpl = function YAxisImpl(_ref) {
	...
	if (axisOptions == null) return null;
	return /*#__PURE__*/ import_react.createElement(CartesianAxis, _extends$8({}, axisOptions, {
		className: clsx("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
		viewBox: {
			x: 0,
			y: 0,
...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
	...
	var result = PREFIX_LIST.reduce(function(res, entry) {
		return _objectSpread$8(_objectSpread$8({}, res), {}, _defineProperty$10({}, entry + camelName, value));
	}, {});
	result[name] = value;
	return result;
};
	...
	return _createClass$7(Brush, [
		...
		},
		{
			...
			value: function renderTravellerLayer(travellerX, id) {
				...
				var travellerProps = _objectSpread$7(_objectSpread$7({}, filterProps(this.props, false)), {}, {
					x,
					y,
		...
		},
		{
			...
			value: function renderText() {
				...
				return /*#__PURE__*/ import_react.createElement(Layer, { className: "recharts-brush-texts" }, /*#__PURE__*/ import_react.createElement(Text, _extends$7({
					textAnchor: "end",
					verticalAnchor: "middle",
					x: Math.min(startX, endX) - offset,
					y: y + height / 2
				}, attrs), this.getTextOfTick(startIndex)), /*#__PURE__*/ import_react.createElement(Text, _extends$7({
					textAnchor: "start",
					verticalAnchor: "middle",
		...
		},
		{
			...
			value: function getDerivedStateFromProps(nextProps, prevState) {
				...
				if (data !== prevState.prevData || updateId !== prevState.prevUpdateId) return _objectSpread$7({
					prevData: data,
...
var renderLine = function renderLine(option, props) {
	...
	else line = /*#__PURE__*/ import_react.createElement("line", _extends$5({}, props, { className: "recharts-reference-line-line" }));
	return line;
};
...
function ReferenceLineImpl(props) {
	...
	var lineProps = _objectSpread$5(_objectSpread$5({ clipPath: ifOverflowMatches(props, "hidden") ? "url(#".concat(clipPathId, ")") : void 0 }, filterProps(props, true)), {}, {
		x1,
		y1,
		x2,
		y2
...
var Cross = function Cross(_ref) {
	var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$2(_ref, _excluded$2);
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$3({}, filterProps(props, true), {
...
var _excluded$1 = ["item"], _excluded2 = [
	"children",
	"className",
	"width",
	"height",
...
var getAxisMapByAxes = function getAxisMapByAxes(props, _ref2) {
	...
	return axes.reduce(function(result, child) {
		...
		return _objectSpread$1(_objectSpread$1({}, result), {}, _defineProperty$2({}, axisId, _objectSpread$1(_objectSpread$1({}, childProps), {}, {
			axisType,
			domain,
			categoricalDomain,
			duplicateDomain,
...
var getAxisMapByItems = function getAxisMapByItems(props, _ref3) {
	...
	var index = -1;
	return graphicalItems.reduce(function(result, child) {
		var axisId = (child.type.defaultProps !== void 0 ? _objectSpread$1(_objectSpread$1({}, child.type.defaultProps), child.props) : child.props)[axisIdKey];
		...
		if (!result[axisId]) {
			...
			return _objectSpread$1(_objectSpread$1({}, result), {}, _defineProperty$2({}, axisId, _objectSpread$1(_objectSpread$1({ axisType }, Axis.defaultProps), {}, {
				hide: true,
...
var calculateOffset = function calculateOffset(_ref5, prevLegendBBox) {
	...
	var offsetH = Object.keys(yAxisMap).reduce(function(result, id) {
		...
		if (!entry.mirror && !entry.hide) return _objectSpread$1(_objectSpread$1({}, result), {}, _defineProperty$2({}, orientation, result[orientation] + entry.width));
		return result;
	}, {
		left: margin.left || 0,
		right: margin.right || 0
	});
	var offset = _objectSpread$1(_objectSpread$1({}, Object.keys(xAxisMap).reduce(function(result, id) {
		var entry = xAxisMap[id];
		var orientation = entry.orientation;
		if (!entry.mirror && !entry.hide) return _objectSpread$1(_objectSpread$1({}, result), {}, _defineProperty$2({}, orientation, (0, import_get.default)(result, "".concat(orientation)) + entry.height));
		return result;
	}, {
		top: margin.top || 0,
	...
	return _objectSpread$1(_objectSpread$1({ brushBottom }, offset), {}, {
		...
		graphicalItems.forEach(function(item, index) {
			...
			var axisObj = axisComponents.reduce(function(result, entry) {
				...
				*/
				...
				var axis = axisMap[id];
				return _objectSpread$1(_objectSpread$1({}, result), {}, _defineProperty$2(_defineProperty$2({}, entry.axisType, axis), "".concat(entry.axisType, "Ticks"), getTicksOfAxis(axis)));
			}, {});
			...
			if (itemIsBar) {
				...
				if (barBandSize !== bandSize) barPosition = barPosition.map(function(pos) {
					return _objectSpread$1(_objectSpread$1({}, pos), {}, { position: _objectSpread$1(_objectSpread$1({}, pos.position), {}, { offset: pos.position.offset - barBandSize / 2 }) });
				});
			}
	...
	*/
	var updateStateOfAxisMapsOffsetAndStackGroups = function updateStateOfAxisMapsOffsetAndStackGroups(_ref8, prevState) {
		...
		var axisObj = axisComponents.reduce(function(result, entry) {
			...
			return _objectSpread$1(_objectSpread$1({}, result), {}, _defineProperty$2({}, name, getAxisMap(props, _objectSpread$1(_objectSpread$1({}, entry), {}, {
				graphicalItems,
		...
		return _objectSpread$1(_objectSpread$1({
			formattedGraphicalItems: getFormatItems(props, _objectSpread$1(_objectSpread$1({}, axisObj), {}, {
				dataStartIndex,
				dataEndIndex,
				updateId,
				graphicalItems,
		...
		function CategoricalChartWrapper(_props) {
			...
			_defineProperty$2(_this, "handleLegendBBoxUpdate", function(box) {
				if (box) {
					...
					_this.setState(_objectSpread$1({ legendBBox: box }, updateStateOfAxisMapsOffsetAndStackGroups({
						props: _this.props,
						dataStartIndex,
						dataEndIndex,
						updateId
					}, _objectSpread$1(_objectSpread$1({}, _this.state), {}, { legendBBox: box }))));
				}
			});
			...
			*/
			_defineProperty$2(_this, "handleMouseEnter", function(e) {
				...
				if (mouse) {
					var _nextState = _objectSpread$1(_objectSpread$1({}, mouse), {}, { isTooltipActive: true });
			...
			_defineProperty$2(_this, "triggeredAfterMouseMove", function(e) {
				var mouse = _this.getMouseInfo(e);
				var nextState = mouse ? _objectSpread$1(_objectSpread$1({}, mouse), {}, { isTooltipActive: true }) : { isTooltipActive: false };
			...
			*/
			...
			_defineProperty$2(_this, "handleClick", function(e) {
				var mouse = _this.getMouseInfo(e);
				if (mouse) {
					var _nextState2 = _objectSpread$1(_objectSpread$1({}, mouse), {}, { isTooltipActive: true });
			...
			_defineProperty$2(_this, "applySyncEvent", function(data) {
				...
				if (data.dataStartIndex !== void 0 || data.dataEndIndex !== void 0) _this.setState(_objectSpread$1({
					dataStartIndex,
					dataEndIndex
				}, updateStateOfAxisMapsOffsetAndStackGroups({
					props: _this.props,
			...
			_defineProperty$2(_this, "renderPolarAxis", function(element, displayName, index) {
				...
				return /*#__PURE__*/ (0, import_react.cloneElement)(element, _objectSpread$1(_objectSpread$1({}, axisOption), {}, {
			...
			*/
			_defineProperty$2(_this, "renderLegend", function() {
				...
				var item = props.item;
				return /*#__PURE__*/ (0, import_react.cloneElement)(item, _objectSpread$1(_objectSpread$1({}, _objectWithoutProperties$1(props, _excluded$1)), {}, {
					chartWidth: width,
					chartHeight: height,
					margin,
			...
			*/
			...
			_defineProperty$2(_this, "renderActivePoints", function(_ref10) {
				...
				if (basePoint) result.push(CategoricalChartWrapper.renderActiveDot(activeDot, _objectSpread$1(_objectSpread$1({}, dotProps), {}, {
					cx: basePoint.x,
					cy: basePoint.y
			...
			_defineProperty$2(_this, "renderGraphicChild", function(element, displayName, index) {
				...
				var graphicalItem = /*#__PURE__*/ (0, import_react.cloneElement)(element, _objectSpread$1(_objectSpread$1({}, item.props), itemEvents));
				...
				if (hasActive) if (activeTooltipIndex >= 0) {
					...
					if (activeShape || activeBar) {
						...
						return [
							/*#__PURE__*/ (0, import_react.cloneElement)(element, _objectSpread$1(_objectSpread$1(_objectSpread$1({}, item.props), itemEvents), {}, { activeIndex })),
							null,
							null
						];
					}
					...
					*/
					...
					return [
						/*#__PURE__*/ (0, import_react.cloneElement)(xyItem, _objectSpread$1(_objectSpread$1(_objectSpread$1({}, item.props), itemEvents), {}, { activeIndex: childIndex })),
						null,
						null
					];
				}
			...
			_defineProperty$2(_this, "renderCustomized", function(element, displayName, index) {
				return /*#__PURE__*/ (0, import_react.cloneElement)(element, _objectSpread$1(_objectSpread$1({ key: "recharts-customized-".concat(index) }, _this.props), _this.state));
			});
		...
		return _createClass$2(CategoricalChartWrapper, [
			...
			},
			{
				...
				value: function getMouseInfo(event) {
					...
					if (toolTipData) return _objectSpread$1(_objectSpread$1({}, e), toolTipData);
					return null;
				}
			},
			{
			...
			},
			{
				...
				value: function parseEventsOfWrapper() {
					...
					return _objectSpread$1(_objectSpread$1({}, adaptEventHandlers(this.props, this.handleOuterEvent)), tooltipEvents);
				}
			},
			{
				key: "addListener",
			...
			},
			{
				...
				value: function getXScales() {
					...
					return xAxisMap ? Object.entries(xAxisMap).reduce(function(res, _ref13) {
						...
						return _objectSpread$1(_objectSpread$1({}, res), {}, _defineProperty$2({}, axisId, axisProps.scale));
					}, {}) : null;
				}
			},
			{
				...
				value: function getItemByXY(chartXY) {
					...
					if (formattedGraphicalItems && formattedGraphicalItems.length) for (var i = 0, len = formattedGraphicalItems.length; i < len; i++) {
						...
						if (itemDisplayName === "Bar") {
							...
							return {
								graphicalItem: _objectSpread$1(_objectSpread$1({}, graphicalItem), {}, { childIndex }),
			...
			},
			{
				...
				value: function render() {
					...
					var attrs = filterProps(_objectWithoutProperties$1(_this$props6, _excluded2), false);
					if (compact) return /*#__PURE__*/ import_react.createElement(ChartLayoutContextProvider, {
						state: this.state,
						width: this.props.width,
						height: this.props.height,
						clipPathId: this.clipPathId
					}, /*#__PURE__*/ import_react.createElement(Surface, _extends$2({}, attrs, {
						width,
						height,
						title,
						desc
					...
					return /*#__PURE__*/ import_react.createElement(ChartLayoutContextProvider, {
						...
						height: this.props.height,
						clipPathId: this.clipPathId
					}, /*#__PURE__*/ import_react.createElement("div", _extends$2({
	...
	_defineProperty$2(CategoricalChartWrapper, "defaultProps", _objectSpread$1({
		layout: "horizontal",
		stackOffset: "none",
		barCategoryGap: "10%",
		barGap: 4,
	...
	_defineProperty$2(CategoricalChartWrapper, "getDerivedStateFromProps", function(nextProps, prevState) {
		...
		if (prevState.updateId === void 0) {
			...
			return _objectSpread$1(_objectSpread$1(_objectSpread$1({}, defaultState), {}, { updateId: 0 }, updateStateOfAxisMapsOffsetAndStackGroups(_objectSpread$1(_objectSpread$1({ props: nextProps }, defaultState), {}, { updateId: 0 }), prevState)), {}, {
				prevDataKey: dataKey,
				prevData: data,
				prevWidth: width,
				prevHeight: height,
		...
		if (dataKey !== prevState.prevDataKey || data !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || layout !== prevState.prevLayout || stackOffset !== prevState.prevStackOffset || !shallowEqual(margin, prevState.prevMargin)) {
			...
			var updatesToState = _objectSpread$1(_objectSpread$1({}, getTooltipData(prevState, data, layout)), {}, { updateId: prevState.updateId + 1 });
			var newState = _objectSpread$1(_objectSpread$1(_objectSpread$1({}, _defaultState), keepFromPrevState), updatesToState);
			return _objectSpread$1(_objectSpread$1(_objectSpread$1({}, newState), updateStateOfAxisMapsOffsetAndStackGroups(_objectSpread$1({ props: nextProps }, newState), prevState)), {}, {
				prevDataKey: dataKey,
				prevData: data,
				prevWidth: width,
				prevHeight: height,
		...
		if (!isChildrenEqual(children, prevState.prevChildren)) {
			...
			return _objectSpread$1(_objectSpread$1({ updateId: newUpdateId }, updateStateOfAxisMapsOffsetAndStackGroups(_objectSpread$1(_objectSpread$1({ props: nextProps }, prevState), {}, {
	...
	var CategoricalChart = /*#__PURE__*/ (0, import_react.forwardRef)(function CategoricalChart(props, ref) {
		return /*#__PURE__*/ import_react.createElement(CategoricalChartWrapper, _extends$2({}, props, { ref }));
	});
...
var ZAxis = /*#__PURE__*/ function(_React$Component) {
	function ZAxis() {
		_classCallCheck$1(this, ZAxis);
		return _callSuper$1(this, ZAxis, arguments);
	}
	_inherits$1(ZAxis, _React$Component);
	return _createClass$1(ZAxis, [{
		key: "render",
		value: function render() {
			return null;
		}
...
function ScatterSymbol(_ref) {
	...
	if (typeof option === "string") return /*#__PURE__*/ import_react.createElement(Shape, _extends$1({
		option: /*#__PURE__*/ import_react.createElement(Symbols, _extends$1({ type: option }, props)),
		isActive,
		shapeType: "symbols"
	}, props));
	...
	return _createClass(Scatter, [
		{
			...
			value: function renderSymbolsStatically(points) {
				...
				return points.map(function(entry, i) {
					...
					}, adaptEventsOfChild(_this2.props, entry, i), { role: "img" }), /*#__PURE__*/ import_react.createElement(ScatterSymbol, _extends({
						option,
						isActive,
						key: "symbol-".concat(i)
					}, props)));
			...
			value: function renderSymbolsWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = points.map(function(entry, index) {
						...
						return _objectSpread(_objectSpread({}, entry), {}, { size: interpolator(t) });
					});
		...
		},
		{
			...
			value: function renderLine() {
				...
				else lineItem = /*#__PURE__*/ import_react.createElement(Curve, _extends({}, lineProps, { type: lineJointType }));
				return /*#__PURE__*/ import_react.createElement(Layer, {
...
_defineProperty(Scatter, "getComposedData", function(_ref2) {
	...
	return _objectSpread({ points: displayedData.map(function(entry, index) {
...
//#endregion
export { XAxis as a, CartesianGrid as c, Tooltip as d, Legend as f, YAxis as i, Bar as l, BarChart as n, Area as o, LineChart as r, Line as s, ComposedChart as t, ResponsiveContainer as u };
